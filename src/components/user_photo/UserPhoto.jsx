...
export default function UserPhoto({
  ...
  return (
    ...
    {showname &&
     ...
     <span className={`block w-[35px] h-[35px] rounded-full flex justify-center items-center overflow-hidden border border-[#bf60ee] relative ${ispressed && "scale-105 shadow-lg shadow-[#bf60ee] "} transition-all duration-300 `}
     style = {{
        height: h,
        width: w
     }}
